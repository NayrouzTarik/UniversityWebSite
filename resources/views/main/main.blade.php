...
<body>
    ...
    <div id="sidebar">
        <ul>
            <li><a href="#home"><img src="https://scontent.frba5-1.fna.fbcdn.net/v/t39.30808-1/271158989_10160044111253678_1629923950458083454_n.png?stp=dst-png_p320x320&_nc_cat=105&ccb=1-7&_nc_sid=596444&_nc_ohc=0_WYMjE6-bAAX9ImSw0&_nc_ht=scontent.frba5-1.fna&oh=00_AfBDiVdhVtAR5M89uVUNbSDKo4SuOhIOj1p5JBU2lcUSXw&oe=65A878BD" alt="Home"></a></li>
            ...
            <div class="categories">
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            <li><a href="{{ route('layout') }}/emploi-du-temps">Emploi du Temps</a></li>
